...
public class Przegrany extends Activity {
    String haslo;
    String opcja;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_przegrany);
        Intent intent=this.getIntent();
        haslo=intent.getStringExtra("haslo");
        TextView naPokaz=(TextView) findViewById(R.id.haslo);
        naPokaz.setText("Szukane haslo to:"+haslo);
        Button coLosowac=(Button)findViewById(R.id.los);
